...
* If the product is more than 5 in the the good folder, check if it actually is a new product (this is because this is using the shoot time as one of the reference of a new product and it might have been to close from the previous product.)# file-renaming-cli
